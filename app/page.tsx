      ...
      <div className="space-y-4">
        <section>
          ...
          <ul className="list-disc pl-6">
            <li>
              Create a page that displays a list of cryptocurrency rates using
              the CoinCap API
            </li>
            <li>
              Each crypto should display: rank, name, symbol, and current price
              in USD
            </li>
            <li>Make each crypto clickable to navigate to a detail page</li>
            <li>
              On the detail page, implement a chart showing the price history
            </li>
